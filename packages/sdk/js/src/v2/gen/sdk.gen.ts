 ...
 */
export const globalHealth = <ThrowOnError extends boolean = false>(options?: Options<GlobalHealthData, ThrowOnError>) =>
  (options?.client ?? client).get<GlobalHealthResponses, unknown, ThrowOnError>({ url: "/global/health", ...options })
 ...
 */
export const globalEvent = <ThrowOnError extends boolean = false>(options?: Options<GlobalEventData, ThrowOnError>) =>
  (options?.client ?? client).sse.get<GlobalEventResponses, unknown, ThrowOnError>({ url: "/global/event", ...options })
...
export const globalConfigUpdate = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).patch<GlobalConfigUpdateResponses, GlobalConfigUpdateErrors, ThrowOnError>({
    url: "/global/config",
    ...options,
    headers: {
 ...
 */
export const authRemove = <ThrowOnError extends boolean = false>(options: Options<AuthRemoveData, ThrowOnError>) =>
...
export const projectList = <ThrowOnError extends boolean = false>(options?: Options<ProjectListData, ThrowOnError>) =>
  (options?.client ?? client).get<ProjectListResponses, unknown, ThrowOnError>({ url: "/project", ...options })
 ...
 */
export const ptyList = <ThrowOnError extends boolean = false>(options?: Options<PtyListData, ThrowOnError>) =>
  (options?.client ?? client).get<PtyListResponses, unknown, ThrowOnError>({ url: "/pty", ...options })
 ...
 */
export const ptyCreate = <ThrowOnError extends boolean = false>(options?: Options<PtyCreateData, ThrowOnError>) =>
 ...
 */
export const ptyRemove = <ThrowOnError extends boolean = false>(options: Options<PtyRemoveData, ThrowOnError>) =>
 ...
 */
export const ptyGet = <ThrowOnError extends boolean = false>(options: Options<PtyGetData, ThrowOnError>) =>
  (options.client ?? client).get<PtyGetResponses, PtyGetErrors, ThrowOnError>({ url: "/pty/{ptyID}", ...options })
 ...
 */
export const ptyUpdate = <ThrowOnError extends boolean = false>(options: Options<PtyUpdateData, ThrowOnError>) =>
 ...
 */
export const ptyConnect = <ThrowOnError extends boolean = false>(options: Options<PtyConnectData, ThrowOnError>) =>
...
export const configGet = <ThrowOnError extends boolean = false>(options?: Options<ConfigGetData, ThrowOnError>) =>
  (options?.client ?? client).get<ConfigGetResponses, unknown, ThrowOnError>({ url: "/config", ...options })
...
export const sessionList = <ThrowOnError extends boolean = false>(options?: Options<SessionListData, ThrowOnError>) =>
  (options?.client ?? client).get<SessionListResponses, unknown, ThrowOnError>({ url: "/session", ...options })
 ...
 */
export const sessionTodo = <ThrowOnError extends boolean = false>(options: Options<SessionTodoData, ThrowOnError>) =>
 ...
 */
export const sessionFork = <ThrowOnError extends boolean = false>(options: Options<SessionForkData, ThrowOnError>) =>
  (options.client ?? client).post<SessionForkResponses, unknown, ThrowOnError>({
 ...
 */
export const sessionDiff = <ThrowOnError extends boolean = false>(options: Options<SessionDiffData, ThrowOnError>) =>
 ...
 */
export const partDelete = <ThrowOnError extends boolean = false>(options: Options<PartDeleteData, ThrowOnError>) =>
 ...
 */
export const partUpdate = <ThrowOnError extends boolean = false>(options: Options<PartUpdateData, ThrowOnError>) =>
...
export const sessionPromptAsync = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<SessionPromptAsyncResponses, SessionPromptAsyncErrors, ThrowOnError>({
...
export const permissionRespond = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<PermissionRespondResponses, PermissionRespondErrors, ThrowOnError>({
...
) => (options?.client ?? client).get<PermissionListResponses, unknown, ThrowOnError>({ url: "/permission", ...options })
 ...
 */
export const questionList = <ThrowOnError extends boolean = false>(options?: Options<QuestionListData, ThrowOnError>) =>
  (options?.client ?? client).get<QuestionListResponses, unknown, ThrowOnError>({ url: "/question", ...options })
 ...
 */
export const providerList = <ThrowOnError extends boolean = false>(options?: Options<ProviderListData, ThrowOnError>) =>
  (options?.client ?? client).get<ProviderListResponses, unknown, ThrowOnError>({ url: "/provider", ...options })
 ...
 */
export const providerAuth = <ThrowOnError extends boolean = false>(options?: Options<ProviderAuthData, ThrowOnError>) =>
  (options?.client ?? client).get<ProviderAuthResponses, unknown, ThrowOnError>({ url: "/provider/auth", ...options })
...
export const providerOauthAuthorize = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<ProviderOauthAuthorizeResponses, ProviderOauthAuthorizeErrors, ThrowOnError>({
...
export const providerOauthCallback = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<ProviderOauthCallbackResponses, ProviderOauthCallbackErrors, ThrowOnError>({
...
export const findText = <ThrowOnError extends boolean = false>(options: Options<FindTextData, ThrowOnError>) =>
  (options.client ?? client).get<FindTextResponses, unknown, ThrowOnError>({ url: "/find", ...options })
...
export const findFiles = <ThrowOnError extends boolean = false>(options: Options<FindFilesData, ThrowOnError>) =>
  (options.client ?? client).get<FindFilesResponses, unknown, ThrowOnError>({ url: "/find/file", ...options })
...
export const findSymbols = <ThrowOnError extends boolean = false>(options: Options<FindSymbolsData, ThrowOnError>) =>
  (options.client ?? client).get<FindSymbolsResponses, unknown, ThrowOnError>({ url: "/find/symbol", ...options })
...
export const fileList = <ThrowOnError extends boolean = false>(options: Options<FileListData, ThrowOnError>) =>
  (options.client ?? client).get<FileListResponses, unknown, ThrowOnError>({ url: "/file", ...options })
...
export const fileRead = <ThrowOnError extends boolean = false>(options: Options<FileReadData, ThrowOnError>) =>
  (options.client ?? client).get<FileReadResponses, unknown, ThrowOnError>({ url: "/file/content", ...options })
...
export const fileStatus = <ThrowOnError extends boolean = false>(options?: Options<FileStatusData, ThrowOnError>) =>
  (options?.client ?? client).get<FileStatusResponses, unknown, ThrowOnError>({ url: "/file/status", ...options })
 ...
 */
export const mcpStatus = <ThrowOnError extends boolean = false>(options?: Options<McpStatusData, ThrowOnError>) =>
  (options?.client ?? client).get<McpStatusResponses, unknown, ThrowOnError>({ url: "/mcp", ...options })
 ...
 */
export const mcpAdd = <ThrowOnError extends boolean = false>(options?: Options<McpAddData, ThrowOnError>) =>
 ...
 */
export const mcpAuthStart = <ThrowOnError extends boolean = false>(options: Options<McpAuthStartData, ThrowOnError>) =>
...
export const mcpAuthAuthenticate = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<McpAuthAuthenticateResponses, McpAuthAuthenticateErrors, ThrowOnError>({
 ...
 */
export const mcpConnect = <ThrowOnError extends boolean = false>(options: Options<McpConnectData, ThrowOnError>) =>
 ...
 *
 * Get a list of all running agent processes
 */
export const agentProcessList = <ThrowOnError extends boolean = false>(
  options?: Options<AgentProcessListData, ThrowOnError>,
) =>
  (options?.client ?? client).get<AgentProcessListResponses, unknown, ThrowOnError>({
    url: "/agent-process",
    ...options,
  })
 ...
 *
 * Start a new headless opencode agent process
 */
export const agentProcessSpawn = <ThrowOnError extends boolean = false>(
  options?: Options<AgentProcessSpawnData, ThrowOnError>,
) =>
  (options?.client ?? client).post<AgentProcessSpawnResponses, unknown, ThrowOnError>({
    url: "/agent-process",
    ...options,
    headers: {
      "Content-Type": "application/json",
 ...
 *
 * Send a prompt to a running agent process
 */
export const agentProcessSendPrompt = <ThrowOnError extends boolean = false>(
  options: Options<AgentProcessSendPromptData, ThrowOnError>,
) =>
  (options.client ?? client).post<AgentProcessSendPromptResponses, unknown, ThrowOnError>({
...
/**
 * Cancel an agent process
 *
 * Cancel the current operation of an agent process
 */
export const agentProcessCancel = <ThrowOnError extends boolean = false>(
  options: Options<AgentProcessCancelData, ThrowOnError>,
) =>
  (options.client ?? client).post<AgentProcessCancelResponses, unknown, ThrowOnError>({
 ...
 *
 * Stop and terminate an agent process
 */
export const agentProcessStop = <ThrowOnError extends boolean = false>(
  options: Options<AgentProcessStopData, ThrowOnError>,
) =>
  (options.client ?? client).post<AgentProcessStopResponses, unknown, ThrowOnError>({
...
export const tuiOpenHelp = <ThrowOnError extends boolean = false>(options?: Options<TuiOpenHelpData, ThrowOnError>) =>
  (options?.client ?? client).post<TuiOpenHelpResponses, unknown, ThrowOnError>({ url: "/tui/open-help", ...options })
...
export const tuiExecuteCommand = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).post<TuiExecuteCommandResponses, TuiExecuteCommandErrors, ThrowOnError>({
 ...
 * Publish a TUI event
 */
export const tuiPublish = <ThrowOnError extends boolean = false>(options?: Options<TuiPublishData, ThrowOnError>) =>
...
export const pathGet = <ThrowOnError extends boolean = false>(options?: Options<PathGetData, ThrowOnError>) =>
  (options?.client ?? client).get<PathGetResponses, unknown, ThrowOnError>({ url: "/path", ...options })
 ...
 */
export const vcsGet = <ThrowOnError extends boolean = false>(options?: Options<VcsGetData, ThrowOnError>) =>
  (options?.client ?? client).get<VcsGetResponses, unknown, ThrowOnError>({ url: "/vcs", ...options })
...
export const commandList = <ThrowOnError extends boolean = false>(options?: Options<CommandListData, ThrowOnError>) =>
  (options?.client ?? client).get<CommandListResponses, unknown, ThrowOnError>({ url: "/command", ...options })
...
export const appAgents = <ThrowOnError extends boolean = false>(options?: Options<AppAgentsData, ThrowOnError>) =>
  (options?.client ?? client).get<AppAgentsResponses, unknown, ThrowOnError>({ url: "/agent", ...options })
 ...
 */
export const appSkills = <ThrowOnError extends boolean = false>(options?: Options<AppSkillsData, ThrowOnError>) =>
  (options?.client ?? client).get<AppSkillsResponses, unknown, ThrowOnError>({ url: "/skill", ...options })
 ...
 */
export const lspStatus = <ThrowOnError extends boolean = false>(options?: Options<LspStatusData, ThrowOnError>) =>
  (options?.client ?? client).get<LspStatusResponses, unknown, ThrowOnError>({ url: "/lsp", ...options })
...
) => (options?.client ?? client).get<FormatterStatusResponses, unknown, ThrowOnError>({ url: "/formatter", ...options })
...
) => (options?.client ?? client).sse.get<EventSubscribeResponses, unknown, ThrowOnError>({ url: "/event", ...options })
